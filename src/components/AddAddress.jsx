...
function AddAddress() {
    ...
    //Funcion para regresar a revisar un pedido
    const reviewPayment = () => {
        updateStepOrder(2);
    ...
    return (
            ...
            <div className="bg-zinc-800 p-10 rounded-md w.full">
                ...
                <form onSubmit={onSubmit} >
                    ...
                    <div>
                        ...
                        <div className="relative flex">
                            <input type="text"
                                ...
                                {...register("address")}
                            />
                            <div className="absolute insert-y-0 left-0 pl-3
                    ...
                    <div className="flex justify-between px-4 pt-2">
                        ...
                        <button className="bg-transparent hover:bg-yellow-700
        ...
        type="button"
        >
    Metodo de pago<GrFormPreviousLink className="ml-2 w-5 h-5" size={30} />
</button>
         </Tooltip>
           ...
           Finalizar pedido <GrFormNextLink className="ml-2 w-5 h-5" size={30} />
                        ...
                        <ConfirmModal
                            ...
                            text="¿Estás seguro de que deseas confirmar este pedido? Esta acción no se puede deshacer."
                            btnAccept={"Confirmar"}
                            btnCancel={"Cancelar"}
                        />
                    </div>
