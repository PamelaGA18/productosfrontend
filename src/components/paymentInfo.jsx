...
import PaymentMethodIcon from "./PaymenMehodIcon";
...
function PaymentInfo({ method, cardDetails, userName }) {
  return (
    <div className="space-y-4 p-4 bg-white shadow-lg py-2 rounded-md text-gray-950 text-xs">
      {method === "card" ? (
        <div className="space-y-4 p-4 bg-white shadow-lg py-2 rounded-md text-gray-950">
        ...
        <div className="space-y-4 p-4 bg-white shadow-lg py-2 rounded-md text-gray-950">
          <div className="flex justify-between">
            <span className="flex font-semibold mb-1">
              <IoStorefrontOutline size={20} className="mr-2" /> Metodo de
              entrega:
            </span>
          ...
          <div className="flex justify-between">
            <span className="flex font-semibold mb-1">
              <IoPersonOutline size={20} className="mr-2" /> Nombre de quien
              recoge:
            </span>
            <span>{userName}</span>
          </div>
